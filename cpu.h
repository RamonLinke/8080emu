...
private:
    ...
    //  0xC0          0xC1          0xC2          0xC3          0xC4          0xC5          0xC6          0xC7          0xC8          0xC9          0xCA          0xCB          0xCC          0xCD          0xCE          0xCF
        &CPU::RNZ,    &CPU::POP_B,  &CPU::JNZ,    &CPU::JMP,    &CPU::CNZ,    &CPU::PUSH_B, &CPU::ADI,    &CPU::RST0,   &CPU::RZ,     &CPU::RET,    &CPU::JZ,     &CPU::TODO,   &CPU::TODO,   &CPU::CALL,  &CPU::TODO,   &CPU::RST1,
    //  0xD0          0xD1          0xD2          0xD3          0xD4          0xD5          0xD6          0xD7          0xD8          0xD9          0xDA          0xDB          0xDC          0xDD          0xDE          0xDF
        &CPU::RNC,    &CPU::POP_D,  &CPU::JNC,    &CPU::OUT,    &CPU::CNC,    &CPU::PUSH_D, &CPU::SUI,    &CPU::RST2,   &CPU::RC,     &CPU::TODO,   &CPU::JC,     &CPU::IN,     &CPU::TODO,   &CPU::TODO,   &CPU::TODO,   &CPU::RST3,
    //  0xE0          0xE1          0xE2          0xE3          0xE4          0xE5          0xE6          0xE7          0xE8          0xE9          0xEA          0xEB          0xEC          0xED          0xEE          0xEF
        &CPU::RPO,    &CPU::POP_H,  &CPU::JPO,    &CPU::TODO,   &CPU::CPO,    &CPU::PUSH_H, &CPU::ANI,    &CPU::RST4,   &CPU::RPE,    &CPU::PCHL,   &CPU::JPE,    &CPU::TODO,   &CPU::TODO,   &CPU::TODO,   &CPU::TODO,   &CPU::RST5,
    //  0xF0          0xF1          0xF2          0xF3          0xF4          0xF5          0xF6          0xF7          0xF8          0xF9          0xFA          0xFB          0xFC          0xFD          0xFE          0xFF
        &CPU::RP,     &CPU::POP_PSW,&CPU::JP,     &CPU::TODO,   &CPU::CP,     &CPU::PUSH_PSW,&CPU::ORI,   &CPU::RST6,   &CPU::RM,     &CPU::SPHL,   &CPU::JM,    &CPU::TODO,   &CPU::TODO,   &CPU::TODO,   &CPU::TODO,   &CPU::RST7,
    };
};
